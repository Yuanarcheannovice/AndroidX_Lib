package com.archeanx.libx.widget;/**
...
public class VerticalTextview extends TextSwitcher implements ViewSwitcher.ViewFactory {
    ...
    private static final int FLAG_START_AUTO_SCROLL = 111;
    private static final int FLAG_STOP_AUTO_SCROLL = 222;
    ...
    public void startAutoScroll() {
        //每次开始之前，需要清楚handler的消息队列，防止队列重复
        stopAutoScroll();
        if (handler != null) {
