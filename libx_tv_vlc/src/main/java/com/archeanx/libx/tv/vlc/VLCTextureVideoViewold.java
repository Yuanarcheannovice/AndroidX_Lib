package com.archeanx.libx.tv.vlc;//package cn.caratel.lib.vlc;
//
...
//
//import cn.caratel.dj.jh.function.VLCTextureVideoView;
//
///**
// * @author wurenhai
// * @since 2017/4/14
// */
//public class VLCTextureVideoViewold extends TextureView {
//
...
//    /**
//     * 当前TexttureVideoView是否预览完成
//     */
//    private boolean isCreatedDisplay = false;
//
...
//        current = uri;
//        position = 0;
//        if (!isPreparing && mediaPlayer != null && isCreatedDisplay) {
//            isPreparing = true;
...
//
//    @MainThread
//    private void onCreateMediaPlay() {
//        if (isCreatedDisplay && mediaPlayer == null) {
